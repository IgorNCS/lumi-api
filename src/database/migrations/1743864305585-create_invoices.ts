...
export class CreateInvoices1743864305585 implements MigrationInterface {
    name = 'CreateInvoices1743864305585'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."energy_data_energydatatype_enum" AS ENUM('energyEletric', 'energySCEE', 'compensatedEnergy')`);
        await queryRunner.query(`CREATE TABLE "energy_data" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "energyDataType" "public"."energy_data_energydatatype_enum" NOT NULL, "totalAmount" numeric(10,4) NOT NULL, "quantity" numeric(10,4) NOT NULL, "value" numeric(10,4) NOT NULL, "unitPrice" numeric(10,8) NOT NULL, "invoice" uuid NOT NULL, "invoice_id" uuid, CONSTRAINT "UQ_eed689d304e23bc0551bd1718e5" UNIQUE ("invoice"), CONSTRAINT "REL_38a2bfc4e2cb17b1dde45f83a8" UNIQUE ("invoice_id"), CONSTRAINT "PK_13de4935c907133cee13629002a" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "invoice" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "installation" character varying NOT NULL, "client" character varying NOT NULL, "dueDate" character varying NOT NULL, "totalAmount" numeric(10,4) NOT NULL, "publicContribution" numeric(10,4) NOT NULL, "notaFiscal" character varying NOT NULL, "referencyMonth" character varying NOT NULL, "band" character varying NOT NULL, "user_id" uuid NOT NULL, "company_id" uuid NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, CONSTRAINT "PK_15d25c200d9bcd8a33f698daf18" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."energy_data_energydatatype_enum"`);
    }
